...
The collection_gallery include requires a "collection" variable and has the following option variables: "only", "facet_by", and "num_column". It can be added to a page by inserting and editing the following snippet where you want it to appear:
